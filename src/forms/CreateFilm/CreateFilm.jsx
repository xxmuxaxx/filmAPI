...
let CreateFilmForm = ({message, error, handleSubmit, pristine, submitting}) => {
    return (
        <form className={styles.form} onSubmit={handleSubmit}>
            ...
            <Button type="submit" size="large" color="primary" variant="contained" startIcon={<CloudUploadIcon/>}
